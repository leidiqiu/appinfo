...
public class AppDetailActivity extends SherlockFragmentActivity implements
        TabListener, OnPageChangeListener {

    private String[] TABS_TITLES = { "Activity", "Service", "Receiver",
            "Provider" };
    ...
    private void initTab() {
        ...
        for (String title : TABS_TITLES) {
            Tab tab = mActionBar.newTab().setText(title).setTabListener(this);
